 ...
 *
 * SVG angle convention: 0deg=right, 90deg=down. A quarter fan filling the
 * up-left quadrant from the corner sweeps 180deg->270deg.
 */
...
export type DecorVariant = keyof typeof SHAPES | 'hero';
...
export function CardDecor({
  ...
  if (variant === 'hero') {
    // Same striped fan, drawn in translucent white for the filled brand card.
    return (
      <svg
        className={className}
        viewBox="0 0 170 170"
